                    ...
                    >
                      <div className="pl-2 md:pl-[56px] flex flex-col">
                        {cap.items.map((item, idx) => (
                          ...
                          >
                            <Link 
                              href={item === "Places" ? "/platform/discover/places" : item === "Events" ? "/platform/discover/events" : item === "Businesses" ? "/platform/discover/businesses" : item === "New exploration" ? "/platform/discover/exploration" : item === "Smart routing" ? "/platform/navigation/smart-routing" : item === "Live traffic" ? "/platform/navigation/live-traffic" : item === "Transit" ? "/platform/navigation/transit" : item === "Movement" ? "/platform/navigation/movement-intelligence" : item === "Friends" ? "/platform/connect/friends" : item === "Opportunities" ? "/platform/connect/opportunity-intelligence" : item === "Local groups" ? "/platform/connect/local-coordination" : item === "Nearby Presence" ? "/platform/connect/presence-intelligence" : item === "Neighbourhood" ? "/platform/connect/neighbourhood-intelligence" : item === "User intent" ? "/platform/intelligence/intent-intelligence" : item === "Contextual intelligence" ? "/platform/intelligence/context-intelligence" : item === "Environmental Intelligence" ? "/platform/intelligence/environmental-intelligence" : item === "Curiosity Intelligence" ? "/platform/intelligence/curiosity-intelligence" : item === "Personal rhythm" ? "/platform/intelligence/rhythm-intelligence" : "/in-progress"} 
