...
export default function Navbar({ isGlobal = false }: { isGlobal?: boolean }) {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 px-6 md:px-12 py-6">
      <div className="w-full mx-auto flex items-center justify-between px-6 md:px-8 py-3 bg-[#FCFBF9] border border-brand-blue/5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.03)] rounded-full backdrop-blur-md">
