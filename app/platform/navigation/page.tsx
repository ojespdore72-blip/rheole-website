...
export default function NavigationPage() {
  const subFeatures = [
    { title: "Smart routing", desc: "Routing that adapts dynamically to real-time events.", link: "/platform/navigation/smart-routing" },
    { title: "Live traffic", desc: "Understanding the flow and congestion of the city instantly.", link: "/platform/navigation/live-traffic" },
    { title: "Transit", desc: "Seamless integration with public transport networks.", link: "/platform/navigation/transit" },
    { title: "Movement", desc: "Analysis of physical speed, modality, and trajectory.", link: "/platform/navigation/movement-intelligence" }
  ];
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Helping people move intelligently through the world. Beyond shortest-path logic. Routing that considers safety, weather, live events, and the exact nature of your journey.
          </p>
        </ScrollReveal>
      </section>
