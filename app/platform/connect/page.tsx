...
export default function ConnectPage() {
  const subFeatures = [
    { title: "Friends", desc: "Privacy-first proximity awareness for your closest circle.", link: "/platform/connect/friends" },
    { title: "Opportunities", desc: "Serendipitous encounters and professional networking.", link: "/platform/connect/opportunity-intelligence" },
    { title: "Local groups", desc: "Shared interests organizing naturally in physical spaces.", link: "/platform/connect/local-coordination" },
    { title: "Nearby Presence", desc: "Understanding the crowd and collective movement.", link: "/platform/connect/presence-intelligence" },
    { title: "Neighbourhood", desc: "Deep context on the hyper-local community dynamics.", link: "/platform/connect/neighbourhood-intelligence" }
  ];
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Helping people discover meaningful human relationships. Surfacing serendipitous encounters, local communities, and founders nearby without the noise of traditional social media.
          </p>
        </ScrollReveal>
      </section>
