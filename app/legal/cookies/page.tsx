...
import { cookieReasonsData, cookieCategoriesData, similarTechnologiesData, thirdPartyData } from "@/lib/data/cookies";
        ...
        <ScrollReveal>
          <div className="p-8 md:p-12 rounded-3xl bg-gradient-to-b from-[#111] to-[#0A0A0A] border border-white/[0.05] flex flex-col items-center text-center">
            ...
            <p className="text-[#8A8A8A] text-lg font-light leading-relaxed mb-8 max-w-[600px]">
              Explore our centralized knowledge base for detailed answers regarding Cookies.
            </p>
            <Link 
              href="/resources/faq#section-4"
