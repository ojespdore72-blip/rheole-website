...
export default function PillarPage() {
  const subFeatures = [
    {
        "title": "About Us",
        "desc": "Our story and founding vision.",
        "link": "/company/about/about-us"
    },
    {
        "title": "Manifesto",
        "desc": "Our fundamental beliefs.",
        "link": "/company/about/manifesto"
    },
    {
        "title": "Mission",
        "desc": "What we are working towards.",
        "link": "/company/about/mission"
    },
    {
        "title": "Careers",
        "desc": "Join the team.",
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Who we are and why we exist. The team behind the spatial intelligence revolution.
          </p>
        </ScrollReveal>
      </section>
