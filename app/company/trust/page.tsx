...
export default function PillarPage() {
  const subFeatures = [
    {
        "title": "Security",
        "desc": "Infrastructure and encryption.",
        "link": "/company/trust/security"
    },
    {
        "title": "Trust Center",
        "desc": "Compliance and audits.",
        "link": "/company/trust/trust-center"
    },
    {
        "title": "Privacy",
        "desc": "How we handle your data.",
        "link": "/company/trust/privacy"
    }
];
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Your privacy is paramount. How we secure the worlds most sensitive spatial data.
          </p>
        </ScrollReveal>
      </section>
