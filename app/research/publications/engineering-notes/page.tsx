  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#F2F2F0] flex flex-col items-center justify-center p-6 text-center">
      ...
      <ScrollReveal delay={0.1}>
        <h1 className="text-[40px] md:text-[64px] font-serif-editorial font-light mb-6 tracking-tight">Engineering Notes</h1>
      </ScrollReveal>
      ...
      <ScrollReveal delay={0.3}>
        <Link href="/research/publications" className="inline-flex items-center gap-2 text-[13px] uppercase tracking-widest font-medium text-white hover:text-[#4F6EF7] transition-colors border border-white/[0.1] px-6 py-3 rounded-full hover:bg-white/[0.02]">
