...
export default function PillarPage() {
  const subFeatures = [
    {
        "title": "Whitepapers",
        "desc": "Deep technical explorations.",
        "link": "/research/publications/whitepapers"
    },
    {
        "title": "Case Studies",
        "desc": "Real world implementations.",
        "link": "/research/case-studies"
    },
    {
        "title": "Engineering Notes",
        "desc": "Behind the scenes at Rheole.",
        "link": "/research/publications/engineering-notes"
    },
    {
        "title": "Research Blog",
        "desc": "Weekly thoughts on intelligence.",
        "link": "/research/publications/research-blog"
    }
];
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Read our latest findings, published papers, and extensive case studies.
          </p>
        </ScrollReveal>
      </section>
