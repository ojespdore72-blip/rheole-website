...
import { caseStudiesData, faqsData, observationsData, principlesData } from "@/lib/data/case-studies";
      ...
      <section className="px-6 md:px-12 max-w-[800px] mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            <h2 className="text-[32px] md:text-[48px] text-white font-serif-editorial font-light mb-6">Frequently Asked Questions</h2>
          </div>
        </ScrollReveal>
