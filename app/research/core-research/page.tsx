  ...
  const subFeatures = [
    {
        ...
        "desc": "Understanding what users want.",
        "link": "/research/core-research/intent-intelligence"
    },
    {
        "title": "Context Intelligence",
        "desc": "Parsing environmental states.",
        "link": "/research/core-research/context-intelligence"
    },
    {
        "title": "Spatial Intelligence",
        "desc": "Geometric reasoning systems.",
        "link": "/research/core-research/spatial-intelligence"
    },
    {
        "title": "Urban Computing",
        "desc": "City-scale behavioral analytics.",
        "link": "/research/urban-computing"
    }
];
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Pioneering spatial intelligence algorithms that translate the physical world into computable vectors.
          </p>
        </ScrollReveal>
      </section>
