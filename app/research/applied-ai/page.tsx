...
export default function PillarPage() {
  const subFeatures = [
    {
        "title": "Ambient AI",
        "desc": "Invisible intelligence in everyday objects.",
        "link": "/research/applied-ai/ambient-ai"
    },
    {
        "title": "Human Mobility",
        "desc": "Predicting macro movement patterns.",
        "link": "/research/applied-ai/human-mobility"
    },
    {
        "title": "Environmental",
        "desc": "Reacting to weather and atmosphere.",
        "link": "/research/applied-ai/environmental-intelligence"
    },
    {
        "title": "AI Transparency",
        "desc": "Explainable AI for physical outcomes.",
        "link": "/research/applied-ai/ai-transparency"
    }
];
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#F2F2F0] selection:bg-[#4F6EF7]/30 selection:text-[#F2F2F0] pb-32">
      ...
      <div className="pt-32 px-6 md:px-12 max-w-[1200px] mx-auto">
        <Link href="/research" className="inline-flex items-center gap-2 text-[#8A8A8A] hover:text-white transition-colors text-sm font-medium uppercase tracking-widest">
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        <ScrollReveal>
          <span className="text-[11px] uppercase tracking-[0.2em] text-[#6A6A6A] font-medium">Research Pillar</span>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Bringing AI to the physical world through highly optimized, production-ready systems.
          </p>
        </ScrollReveal>
      </section>
