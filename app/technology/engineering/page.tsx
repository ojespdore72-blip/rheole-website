  ...
  const subFeatures = [
    {
        ...
        "desc": "The ambient models powering Rheole.",
        "link": "/technology/engineering/ai-architecture"
    },
    {
        "title": "Spatial Computing",
        "desc": "How we map intent to the physical world.",
        "link": "/technology/engineering/spatial-computing"
    },
    {
        "title": "Privacy Architecture",
        "desc": "On-device processing and ephemeral contexts.",
        "link": "/technology/engineering/privacy-architecture"
    }
];
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            The backbone of spatial AI. Discover how we build systems that understand the physical world.
          </p>
        </ScrollReveal>
      </section>
