...
export default function PillarPage() {
  const subFeatures = [
    {
        "title": "SDKs",
        "desc": "Native wrappers for iOS, Android and Web.",
        "link": "/technology/developer-platform/sdks"
    },
    {
        "title": "REST APIs",
        "desc": "The complete Reference Catalogue.",
        "link": "/platform/api-references"
    },
    {
        "title": "Realtime APIs",
        "desc": "WebSockets for movement and live events.",
        "link": "/technology/developer-platform/realtime-apis"
    },
    {
        "title": "Authentication",
        "desc": "Secure OAuth and Developer Keys.",
        "link": "/technology/developer-platform/authentication"
    }
];
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#F2F2F0] selection:bg-[#4F6EF7]/30 selection:text-[#F2F2F0] pb-32">
      ...
      <div className="pt-32 px-6 md:px-12 max-w-[1200px] mx-auto">
        <Link href="/technology" className="inline-flex items-center gap-2 text-[#8A8A8A] hover:text-white transition-colors text-sm font-medium uppercase tracking-widest">
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        <ScrollReveal>
          <span className="text-[11px] uppercase tracking-[0.2em] text-[#6A6A6A] font-medium">Technology Pillar</span>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Build on Rheole. The definitive APIs and SDKs to integrate ambient intelligence.
          </p>
        </ScrollReveal>
      </section>
