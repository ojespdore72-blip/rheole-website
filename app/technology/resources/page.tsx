...
export default function PillarPage() {
  const subFeatures = [
    {
        "title": "Status",
        "desc": "Live platform uptime and incident reports.",
        "link": "/technology/resources/status"
    },
    {
        "title": "Roadmap",
        "desc": "What we are building next.",
        "link": "/technology/resources/roadmap"
    },
    {
        "title": "Documentation",
        "desc": "In-depth guides and tutorials.",
        "link": "/technology/resources/documentation"
    },
    {
        "title": "Playground",
        "desc": "Test API requests in your browser.",
        "link": "/technology/resources/interactive-playground"
    }
];
      ...
      <section className="pt-24 px-6 md:px-12 max-w-[1200px] mx-auto flex flex-col gap-8">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-[20px] md:text-[28px] text-[#8A8A8A] font-light max-w-[700px] leading-relaxed">
            Tools & Documentation to help you navigate our ecosystem.
          </p>
        </ScrollReveal>
      </section>
